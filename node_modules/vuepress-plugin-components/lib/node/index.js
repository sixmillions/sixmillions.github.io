...
`)},Oe=(e,t=!0)=>o=>(t&&xe(e),o.env.isDebug&&l.info("Options:",e),$(o,{id:"hope"}),{name:D,define:Ee(e),extendsBundlerOptions:(a,n)=>{e?.components?.includes("ArtPlayer")&&H(a,n,"artplayer"),e?.components?.includes("VidStack")&&K(a,n,/^media-/),_(a,n,["@vuepress/helper","vuepress-shared"])},clientConfigFile:a=>Be(a,e)});export{z as AVAILABLE_SERVICES,r as SHARE_CONFIG,Oe as componentsPlugin,x as pdfLocaleConfig,E as siteInfoLocaleConfig,B as vidstackLocales};
