import { App, ThemeFunction, Plugin, Page, PluginObject, PluginConfig } from 'vuepress/core';
import { Author, BasePageFrontMatter } from 'vuepress-shared';
import { ThemeData as ThemeData$1 } from '@vuepress/plugin-theme-data';
import { FontIconAssets, ComponentPluginOptions } from 'vuepress-plugin-components';
import { BlogPluginPageData, BlogPluginOptions, BlogTypeOptions, BlogCategoryOptions } from '@vuepress/plugin-blog';
...
import { SearchProPluginOptions } from 'vuepress-plugin-search-pro';
import { WatermarkPluginOptions } from '@vuepress/plugin-watermark';
import { Plugin as Plugin$1 } from 'vuepress';
...
interface PortfolioHomeFrontmatter {
    name?: string;
    titles?: string[];
    avatar: string | null;
...
interface PluginsOptions {
     ...
     */
    mdEnhance?: (Omit<MarkdownEnhancePluginOptions, "hint"> & {
        /**
 ...
 */
declare const convertFrontmatter: (frontmatter: Record<string, unknown>, filePathRelative: string) => ThemePageFrontmatter & Record<string, unknown>;

/**
 * @deprecated You should use V2 standard navbar config and avoid using it
 */
declare const convertNavbarOptions: (config: unknown) => NavbarOptions | false;

/**
 * @deprecated You should use V2 standard sidebar config and avoid using it
 */
declare const convertSidebarOptions: (config: unknown) => SidebarOptions | false;
...
type ThemeComponentPluginHelper = Helper<ComponentPluginOptions | false>;
type ThemeCopyCodePluginHelper = Helper<CopyCodePluginOptions | false>;
type ThemeCopyrightPluginHelper = Helper<CopyrightPluginOptions | false>;
type ThemeFeedPluginHelper = Helper<Omit<FeedPluginOptions, "hostname"> | false>;
type ThemeGitPluginHelper = Helper<GitPluginOptions | false>;
type ThemeLinksCheckPluginHelper = Helper<LinksCheckPluginOptions | false>;
type ThemeMdEnhancePluginHelper = Helper<MarkdownEnhancePluginOptions | false>;
type ThemePhotoSwipePluginHelper = Helper<PhotoSwipePluginOptions | false>;
type ThemePrismJsPluginHelper = Helper<PrismjsOptions | false>;
type ThemePwaPluginHelper = Helper<PwaPluginOptions | false>;
type ThemeReadingTimePluginHelper = Helper<ReadingTimePluginOptions | false>;
type ThemeRedirectPluginHelper = Helper<RedirectPluginOptions | false>;
type ThemeSEOPluginHelper = Helper<Omit<SeoPluginOptions, "hostname" | "author"> | false>;
type ThemeSitemapPluginHelper = Helper<Omit<SitemapPluginOptions, "hostname"> | false>;
...
declare const linkCheck: ThemeLinksCheckPluginHelper;
 ...
 */
declare const getCatalogPlugin: (catalog?: CatalogPluginOptions | boolean) => Plugin | null;

/** @private */
declare const getBlogPlugin: (themeData: ThemeData, options?: BlogOptions | boolean, hotReload?: boolean) => Plugin | null;

/** @private */
declare const getBlogCategoryCategory: (options: BlogOptions, themeData: ThemeData) => BlogCategoryOptions<{
    git: GitData;
}, ThemeNormalPageFrontmatter, {
    routeMeta: ArticleInfoData;
}>;
/** @private */
declare const getBlogTagCategory: (options: BlogOptions, themeData: ThemeData) => BlogCategoryOptions<{
    git: GitData;
}, ThemeNormalPageFrontmatter, {
    routeMeta: ArticleInfoData;
}>;
...
/** @private */
declare const getBlogArticleType: (options: BlogOptions, themeData: ThemeData) => BlogTypeOptions<{
    git: GitData;
}, ThemeNormalPageFrontmatter, {
    routeMeta: ArticleInfoData;
}>;
/** @private */
declare const getBlogStarType: (options: BlogOptions, themeData: ThemeData) => BlogTypeOptions<{
    git: GitData;
}, ThemeNormalPageFrontmatter, {
    routeMeta: ArticleInfoData;
}>;
/** @private */
declare const getBlogTimelineType: (options: BlogOptions, themeData: ThemeData) => BlogTypeOptions<{
    git: GitData;
}, ThemeNormalPageFrontmatter, {
    routeMeta: ArticleInfoData;
}>;
 ...
 */
declare const getCommentPlugin: (options?: Partial<CommentPluginOptions> | false) => PluginObject | null;
 ...
 */
declare const getComponentsPlugin: (options: Pick<ThemeOptions, "hostname" | "hotReload" | "iconAssets" | "iconPrefix">, { components, componentOptions, rootComponents, }?: ComponentPluginOptions, legacy?: boolean) => Plugin;
 ...
 */
declare const getCopyCodePlugin: (options?: CopyCodePluginOptions | boolean) => Plugin | null;
 ...
 */
declare const getCopyrightPlugin: (themeData: ThemeData, options?: Partial<CopyrightPluginOptions> | boolean, hostname?: string) => Plugin | null;
 ...
 */
declare const getFeedPlugin: (themeData: ThemeData, options?: Omit<FeedPluginOptions, "hostname"> | boolean | undefined, hostname?: string, favicon?: string, legacy?: boolean) => Plugin | null;
 ...
 * Get theme plugins
 */
declare const getPlugins: (app: App, pluginsOptions: PluginsOptions, themeData: ThemeData, options: Pick<ThemeOptions, "hostname" | "hotReload" | "iconAssets" | "iconPrefix" | "favicon">, legacy?: boolean) => PluginConfig;
 ...
 */
declare const getMdEnhancePlugin: (options?: Partial<MarkdownEnhancePluginOptions> | false, legacy?: boolean) => Plugin | null;
 ...
 */
declare const getNoticePlugin: (options?: NoticePluginOptions | NoticeOptions[]) => Plugin$1 | null;
 ...
 */
declare const getPhotoSwipePlugin: (options?: PhotoSwipePluginOptions | boolean) => Plugin | null;
 ...
 */
declare const usePrismjsPlugin: (app: App) => void;
/**
 * @private
 *
 ...
 */
declare const getPwaPlugin: (options?: PwaPluginOptions | boolean, favicon?: string) => Plugin | null;
 ...
 */
declare const getSearchPlugin: (app: App, themeData: ThemeData, plugins: PluginsOptions) => Plugin | null;
 ...
 */
declare const getSEOPlugin: (themeData: ThemeData, { seo }: PluginsOptions, hostname?: string) => Plugin | null;
 ...
 */
declare const getSitemapPlugin: (options?: Omit<SitemapPluginOptions, "hostname"> | boolean, hostname?: string) => Plugin | null;
 ...
 */
declare const usePlugins: (app: App, themeData: ThemeData, plugins: PluginsOptions, hotReload: boolean, behavior: HopeThemeBehaviorOptions) => void;
 ...
 */
declare const getWatermarkPlugin: (options?: WatermarkPluginOptions | boolean) => Plugin$1 | null;

/**
 * @private
 */
declare const prepareBundleConfigFile: (app: App, { enableCatalog, enableBlog, enableEncrypt, enableSlide }: ThemeStatus) => Promise<string>;
 ...
 * @private
 */
declare const prepareSeparatedConfigFile: (app: App, { enableCatalog, enableBlog, enableEncrypt, enableSlide }: ThemeStatus) => Promise<string>;
...
export { type AppearanceConfig, type AppearanceLocaleData, type AppearanceOptions, ArticleInfo, type ArticleInfoData, type AutoLinkOptions, type BlogLocaleConfig, type BlogLocaleData, type BlogLocaleOptions, type BlogOptions, type DarkmodeOptions, type DirInfo, type DocsRepoLocaleOptions, type EncryptConfig, type EncryptLocaleData, type EncryptOptions, type FeatureConfig, type FeatureLocaleConfig, type FeatureLocaleData, type FeatureLocaleOptions, type FeatureOptions, type FileInfo, type FooterLocaleOptions, type HopeThemeBehaviorOptions, type InfoOptions, type LayoutLocaleConfig, type LayoutLocaleData, type LayoutLocaleOptions, type LayoutOptions, type MetaLocaleOptions, type MetaLocateData, type NavGroup, type NavbarComponent, type NavbarGroup, type NavbarItem, type NavbarLayoutOptions, type NavbarLocaleData, type NavbarLocaleOptions, type NavbarOptions, type OutlookLocaleData, PageInfo, type PageInfoData, type PageInfoType, PageType, type PaginationLocaleData, type PluginsOptions, type PortfolioHomeFrontmatter, type PrismjsDarkTheme, type PrismjsLightTheme, type PrismjsOptions, type PrismjsTheme, type RouteLocaleData, type SidebarArrayOptions, type SidebarDirInfo, type SidebarFileInfo, type SidebarGroupItem, type SidebarInfo, type SidebarItem, type SidebarLocaleOptions, type SidebarObjectOptions, type SidebarOptions, type SidebarPageItem, type SidebarSorter, type SidebarSorterFunction, type SidebarSorterKeyword, type SidebarStructureItem, type StructureInfo, type TextItemOptions, type ThemeBackToTopPluginHelper, type ThemeBlogHomePageFrontmatter, type ThemeBlogHomeProjectOptions, type ThemeBlogPluginHelper, type ThemeCommentPluginHelper, type ThemeComponentPluginHelper, type ThemeCopyCodePluginHelper, type ThemeCopyrightPluginHelper, type ThemeData, type ThemeFeedPluginHelper, type ThemeGitPluginHelper, type ThemeHopePageFrontmatter, type ThemeLinksCheckPluginHelper, type ThemeLocaleConfig, type ThemeLocaleData, type ThemeLocaleOptions, type ThemeMdEnhancePluginHelper, type ThemeNavbarHelper, type ThemeNormalPageFrontmatter, type ThemeOptions, type ThemePageData, type ThemePageFrontmatter, type ThemePhotoSwipePluginHelper, type ThemePrismJsPluginHelper, type ThemeProjectHomeActionOptions, type ThemeProjectHomeFeatureItem, type ThemeProjectHomeFeatureOptions, type ThemeProjectHomeHighlightItem, type ThemeProjectHomeHighlightOptions, type ThemeProjectHomePageFrontmatter, type ThemePwaPluginHelper, type ThemeReadingTimePluginHelper, type ThemeRedirectPluginHelper, type ThemeSEOPluginHelper, type ThemeSidebarArrayHelper, type ThemeSidebarHelper, type ThemeSidebarObjectHelper, type ThemeSitemapPluginHelper, type ThemeStatus, arraySidebar, backToTop, blog, blogFilter, checkLegacyStyle, comment, components, convertFrontmatter, convertNavbarOptions, convertSidebarOptions, convertThemeOptions, copyCode, copyright, defaultPageSorter, extendsBundlerOptions, extendsPagePlugin, feed, getActiveHeaderLinksPlugin, getAlias, getBlogArticleType, getBlogCategoryCategory, getBlogPlugin, getBlogStarType, getBlogTagCategory, getBlogTimelineType, getCatalogPlugin, getCommentPlugin, getComponentsPlugin, getCopyCodePlugin, getCopyrightPlugin, getEncryptConfig, getFeedPlugin, getMdEnhancePlugin, getNoticePlugin, getPhotoSwipePlugin, getPlugins, getPwaPlugin, getRtlPlugin, getSEOPlugin, getSearchPlugin, getSidebarData, getSidebarSorter, getSitemapPlugin, getSocialMediaIcons, getStructureInfo, getThemeData, getThemeStatus, getWatermarkPlugin, git, hopeTheme, injectBlogBasicInfo, injectPageInfo, linkCheck, mdEnhance, navbar, objectSidebar, photoSwipe, prepareBundleConfigFile, prepareHighLighterScss, prepareSeparatedConfigFile, prepareSidebarData, prepareSocialMediaIcons, prismjs, pwa, readingTime, redirect, removePrismjsPlugin, seo, sidebar, sidebarDateDescSorter, sidebarDateSorter, sidebarFilenameSorter, sidebarOrderSorter, sidebarReadmeSorter, sidebarTitleSorter, sitemap, themeLocalesData, useExtendsPagePlugin, usePlugins, usePrismjsPlugin };
