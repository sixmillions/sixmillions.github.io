...
export const useNavbarLanguageDropdown = () => {
    ...
    return computedWithControl(__VUEPRESS_DEV__
        ? (() => [
            route.path,
        ...
        const languageDropdown = {
            ...
            children: [
                ...
                ...extraLocales.map(([text, path]) => ({
                    text,
                    link: path.replace(":route", route.path.replace(routeLocale.value, "")),
                })),
            ],
        };
...
//# sourceMappingURL=useNavbarLanguageDropdown.js.map